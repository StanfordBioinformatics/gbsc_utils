...
class IlluminaMismatches
  ...
  def make_plots
    ...
    datacmd = "bwa_mismatches --out #{tmpio.path} #{@bam_files.join(' ')}"
    ...
    # make plots
    run_plotter("plot_mismatch_details.r", tmpio.path, @details_plot)
    run_plotter("plot_mismatch_summary.r", tmpio.path, @summary_plot)

...
class IlluminaIntensities
  ...
  def make_raw_intensity_plots(lane)
    ...
    run_plotter("plot_intensity_summary.r", tmpio.path, @raw_summary_plot) unless @raw_summary_plot.nil?
    run_plotter("plot_intensity_details.r", tmpio.path, @raw_details_plot) unless @raw_details_plot.nil?
  ...
  def make_focus_plots(lane)
    ...
    run_plotter("plot_fwhm_summary.r", tmpio.path, @focus_summary_plot) unless @focus_summary_plot.nil?
  ...
  def make_corrected_intensity_plots(lane)
    ...
    run_plotter("plot_intensity_summary.r", tmpio.path, @corr_summary_plot) unless @corr_summary_plot.nil?
    run_plotter("plot_intensity_details.r", tmpio.path, @corr_details_plot) unless @corr_details_plot.nil?
  ...
  def make_basecall_plots(lane)
    ...
    run_plotter("plot_call_summary.r", tmpio.path, @call_summary_plot) unless @call_summary_plot.nil?
    run_plotter("plot_call_details.r", tmpio.path, @call_details_plot) unless @call_details_plot.nil?

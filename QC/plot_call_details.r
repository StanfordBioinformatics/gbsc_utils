...
#
# Make a detailed plot of base calls.
#
# Usage: Rscript plot_call_details.r options
# Options:
...
plot(x=c(1:nrow(data)), y=data$a, type='s', col="gray", lwd=2,
     xlab="Cycle", ylab="Percent Base Calls", ylim=c(0, 100),
...
points(x=c(1:nrow(data)), y=data$n, type='s', col="yellow", lwd=2)
axis(1, 1:nrow(data))
axis(2, tck=1)

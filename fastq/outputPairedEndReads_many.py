...
for line in fh:
	...
	if qsub:
		cmd = "qsub -v PYTHONPATH={PYTHONPATH} -R y -l h_vmem=32G -m ea -M {notify} -wd {outdir} {cmd}".format(notify=notify,outdir=outdir,cmd=cmd,PYTHONPATH=os.getenv('PYTHONPATH'))
		print(cmd)
